...
document.getElementById("toTop").setAttribute("style", "display: none; position: fixed; bottom: 18px; right: 18px; z-index: 1000; border: 3px solid black; border-radius: 100%; color: orange; outline: none; background-color: #ffc61a; cursor: pointer; height: 60px; width: 60px; box-shadow: 0px 0px 10.3px 1.7px #ffc61a;");
